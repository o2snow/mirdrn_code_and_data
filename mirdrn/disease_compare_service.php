...
body table tr td table tr td table tr td table tr {
	text-align: center;
}
#disease_1 {
	text-align: left;
...
<script type="text/javascript" src="./js/compareservice.js"></script>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <table width="1024" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td align="center"><table width="740" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="center"><img src="img/ncRANppi_icon_diseases_on.png" name="disease" width="101" height="111" id="disease"></td>
            </tr>
        </table></td>
      </tr>
      <tr>
      ...
      <tr>
        <td align="center"><table width="1024" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="13" height="25" background="./img/fram_upper_left.png">&nbsp;</td>
            <td width="998" height="25" background="./img/fram_top.png"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="3%">&nbsp;</td>
            ...
            <td width="13" height="25" background="./img/fram_upper_right.png">&nbsp;</td>
          </tr>
          <tr>
            <td width="13" background="./img/fram_side.png">&nbsp;</td>
            <td width="998" align="center"><table width="98%" border="0" cellspacing="1" cellpadding="0">
              <tr>
                <td height="26" align="right">&nbsp;</td>
                <td bgcolor="#FFFFFF" align="center">Disease 1</td>
                <td bgcolor="#FFFFFF" align="center">Disease 2</td>
              </tr>
              <tr>
                <td height="26" align="right">&nbsp;</td>
                <td align="center" bgcolor="#FFFFFF">
                <select name="disease_1" id="disease_1" style="width:320px">
                ...
                <td align="center"><select name="disease_2" id="disease_2" style="width:320px">
                  <option value="" selected="SELECTED">-------------- Select one disease -----------</option>
                  <option value="Acute">Acute</option>
                  <option value="Adenocarcinoma">Adenocarcinoma</option>
                  <option value="Alzheimer Disease">Alzheimer Disease</option>
              ...
              <tr>
                <td width="28%" height="26" align="right" bgcolor="#F0F1F4">Tissue/Tumor type :</td>
                <td width="36%" align="center" bgcolor="#F0F1F4" ><select name="tissue" id="tissue" style="width:320px">
                ...
                <td width="36%" align="center" bgcolor="#F0F1F4"><select name="tissue2" id="tissue2" style="width:320px">
                  <option value="" selected="selected">-------------- tissue types --------------</option>
                  <option value="adult">adult</option>
                  <option value="adipose tissue">adipose tissue</option>
                  <option value="adrenal gland">adrenal gland</option>
              ...
              <tr>
                <td height="26" align="right" bgcolor="#FFFFFF">Common expression of target gene, gene 1 and gene 2 nodes in KEGG (optional):</td>
                <td bgcolor="#FFFFFF"><label><input type="checkbox" name="common_pathway" id="common_pathway">Yes</label></td>
                <td bgcolor="#FFFFFF"><label><input type="checkbox" name="common_pathway2" id="common_pathway2">Yes</label></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="35%" align="center"><label for="cancerous4"></label>
                      <select name="cancerous4" id="cancerous4" class="table_text">
                        <option value="" selected="selected"></option>
                        <option value="CRG">CRG</option>
                        <option value="OCG">OCG</option>
                        <option value="TSG">TSG</option>
                      </select></td>
                    <td width="32%" align="center"><select name="cancerous5" id="cancerous5" class="table_text">
                      <option value="" selected="selected"></option>
                      <option value="CRG">CRG</option>
                      <option value="OCG">OCG</option>
                      <option value="TSG">TSG</option>
                    </select></td>
                    <td width="33%" align="center"><select name="cancerous6" id="cancerous6" class="table_text">
                      <option value="" selected></option>
                      <option value="CRG">CRG</option>
                      <option value="OCG">OCG</option>
                      <option value="TSG">TSG</option>
              ...
              <tr>
                <td height="26" align="right" bgcolor="#F0F1F4">Filter out receptor protein (optional):</td>
                <td bgcolor="#F0F1F4"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="35%" align="center"><input type="checkbox" name="receptor1" id="receptor1"></td>
                ...
                <td bgcolor="#F0F1F4"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="35%" align="center"><input type="checkbox" name="receptor4" id="receptor4"></td>
                    <td width="32%" align="center"><input type="checkbox" name="receptor5" id="receptor5"></td>
                    <td width="33%" align="center"><input type="checkbox" name="receptor6" id="receptor6"></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
                <td height="26" align="right" bgcolor="#FFFFFF">Selectoin of  transcription factor (optional):</td>
                <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                ...
                <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="35%" align="center"><input type="checkbox" name="transcription4" id="transcription4"></td>
                    <td width="32%" align="center"><input type="checkbox" name="transcription5" id="transcription5"></td>
                    <td width="33%" align="center"><input type="checkbox" name="transcription6" id="transcription6"></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
                <td height="26" align="right" bgcolor="#F0F1F4">Pathway ranking by:</td>
                <td colspan="2" align="center" bgcolor="#F0F1F4">
                  <span class="table_text">&nbsp;
                    <label for="ranking"></label>
                    <select name="ranking" id="ranking">
                      <option value="molecular_function">== Jaccard index (MF) ==</option>
              ...
              <tr>
                ...
                <td align="center" valign="middle" bgcolor="#FFFFFF">P-Value&nbsp;&lt
                  <input name="pvalue" type="text" id="pvalue" size="12">&nbsp;(ex: 0.001)</td>
                <td align="center" valign="middle" bgcolor="#FFFFFF">P-Value&nbsp;&lt
                  <input name="pvalue2" type="text" id="pvalue2" size="12">&nbsp;(ex: 0.001)</td>
              </tr>
              </table></td>
            <td width="13" background="./img/fram_side.png">&nbsp;</td>
          </tr>
          <tr>
            <td width="13" height="25" background="./img/fram_lower_left.png">&nbsp;</td>
            <td width="998" height="25" background="./img/fram_bottom.png">&nbsp;</td>
            <td width="13" height="25" background="./img/fram_lower_right.png">&nbsp;</td>
          </tr>
        </table></td>
      </tr>
      <tr>
    ...
    <td align="center" bgcolor="#96CDED" id="associated_mirnas_viewer"><table width="1024" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td align="center"><table width="963" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td>&nbsp;</td>
            <td height="25" class="sub_title">Disease 1 associated miRNAs</td>
            <td>&nbsp;</td>
          </tr>
          <tr>
              ...
              <tr>
                ...
                <td><table width="100%" border="0" cellspacing="1" cellpadding="0">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td align="left" class="text_item" id="disease_1_assoicated_gene_total">Total:</td>
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
          ...
          <tr>
            ...
            <td align="center"><table width="96%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="1%">&nbsp;</td>
                <td>
                	<table width="100%" border="0" cellspacing="1" cellpadding="0" id="disease_1_associated_mirnas">                  
                  	</table>
                </td>
                <td width="1%">&nbsp;</td>
                </tr>
      ...
      <tr>
        <td align="center"><table width="963" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td>&nbsp;</td>
            <td height="25" class="sub_title">Disease 2 associated miRNAs</td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td width="11" background="./img/fram_upper_left.png">&nbsp;</td>
            ...
            <td align="center"><table width="96%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td><table width="100%" border="0" cellspacing="1" cellpadding="0">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td align="left" class="text_item" id="disease_2_assoicated_gene_total">Total:</td>
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
                      <td align="right" class="text_item">&nbsp;</td>
                    </tr>
          ...
          <tr>
            ...
            <td align="center"><table width="96%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="1%">&nbsp;</td>
                <td><table width="100%" border="0" cellspacing="1" cellpadding="0" id="disease_2_associated_mirnas">
                </table></td>
                <td width="1%">&nbsp;</td>
              </tr>
            </table></td>
            ...
            <td align="center"><table width="96%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td><table width="100%" border="0" cellspacing="1" cellpadding="0" id="associated_mirnas5">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td align="left" class="text_item" id="target_gene_total">Total:</td>
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
                      <td align="right" class="text_item">&nbsp;</td>
                    </tr>
              ...
              <tr>
                ...
                <td><table width="100%">
                  <tr>
                     ...
                     <td colspan="2" align="left" class="text_item">Gene filter <input name="genefilter" id="genefilter" type="text"> 
                  ...
                  <tr>
                    ...
                    <td width="54%" align="left" class="text_item">Sort by
                      ...
                      <input type="text" name="subview_top" id="subview_top" style="width:70px">&nbsp;sub-pathways&nbsp;
  ...
  <tr>
    <td align="center" bgcolor="#B587D6" id="comorbidity_gene_viewer"><table width="1024" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td align="center"><table width="963" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td>&nbsp;</td>
            <td height="25" class="sub_title">
            	<table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="50%" align="left">Comorbidity Gene</td>
                    <td width="50%" align="right"><input type="submit" name="export_com" id="export_com" value="Export Data"></td>
                  </tr>
                </table>
            </td>
            <td>&nbsp;</td>
            ...
            <td align="center"><table width="96%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td><table width="100%" border="0" cellspacing="1" cellpadding="0" id="associated_mirnas">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="55%" align="left" class="text_item" id="comorbidity_gene_total">Total:</td>
                      <td width="15%">&nbsp;</td>
                      <td width="5%">&nbsp;</td>
                      <td width="25%" align="right" class="text_item_tb">
                      <a href="#" id="com_pre" onclick="PrevComorbidityGeneViews(); return false;">&lt;&lt; Prev</a> | <a href="#" id="com_next" onclick="NextComorbidityGeneViews(); return false;">Next &gt;&gt;</a>
                      </td>
                    </tr>
                  </table></td>
                <td width="1%">&nbsp;</td>
          ...
          <tr>
            ...
            <td align="center"><table width="96%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="1%">&nbsp;</td>
                <td><table width="100%" border="0" cellspacing="1" cellpadding="0" id="comorbidity_gene">
                </table></td>
                <td width="1%">&nbsp;</td>
              </tr>
            </table></td>
    ...
    <td align="center" bgcolor="#DDAE85" id="network_viewer"><table width="90%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td width="11">&nbsp;</td>
            <td width="1002" height="25" background="./img/fram_top.png">&nbsp;</td>
            <td width="11">&nbsp;</td>
          </tr>
          <tr>
            <td width="11">&nbsp;</td>
            <td align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td>&nbsp;</td>
                <td align="left"><img src="img/labele3.png" width="550" height="54"></td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
            ...
            <td height="25" align="center"><table width="96%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td align="center"><table width="963" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td>&nbsp;</td>
                    <td height="25" align="left" class="sub_title">Information for selected node:</td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td width="11" background="./img/fram_upper_left.png">&nbsp;</td>
                    ...
                    <td align="center"><table width="96%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td align="center"><table width="900" border="0" cellspacing="1" cellpadding="0">
                          <tr>
                            <td width="160" align="right" class="text_item">Gene:</td>
                            <td width="740" align="left" bgcolor="#FFFFFF" id="network_gene">&nbsp;</td>
                          </tr>
                          <tr>
                            <td align="right" class="text_item">Cancerous protein:</td>
                            <td align="left" valign="middle" bgcolor="#FFFFFF" id="network_cancerous">&nbsp;</td>
                          </tr>
                           <tr>
                            <td align="right" class="text_item">OMIM ID:</td>
                            <td align="left" bgcolor="#FFFFFF" id="network_omim">&nbsp;</td>
                          </tr>
                          <tr>
                            <td align="right" valign="top" class="text_item">KEGG pathway:</td>
