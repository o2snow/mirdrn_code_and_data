	...
	public static void main(String[] args) {
		...
		try {
			...
			for (String item1 : itemArray) {
				...
				String cnUrl = "/map/service/GetDiseaseMap?token=B481A5E1D39B47FDF9DBEB8A13F786A4&disease=Alzheimer%20Disease&tissue="+item1+"&ranking="+sFunction+"&pvalue=0.005";						
				...
				LinkedHashMap uniGeneSizeInNetwork = new LinkedHashMap();
				...
				System.out.println(item1+" "+uniGeneSizeInNetwork.size());
