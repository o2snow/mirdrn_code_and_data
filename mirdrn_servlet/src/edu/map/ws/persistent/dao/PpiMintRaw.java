...
/**
 * PpiMintRaw generated by hbm2java
 */
public class PpiMintRaw implements java.io.Serializable {
	...
	public PpiMintRaw(String idA, String idB, int geneIdA, int geneIdB,
			...
			int identifier, String confidence) {
		this.idA = idA;
		this.idB = idB;
