 ...
 * @see edu.map.ws.persistent.dao.Tag
...
public class TagHome {
	...
	public Tag findById(java.lang.Integer id) {
		...
		try {
			Tag instance = (Tag) sessionFactory.getCurrentSession().get(
					"edu.map.ws.persistent.dao.Tag", id);
			if (instance == null) {
	...
	public List<Tag> findByExample(Tag instance) {
		...
		try {
			List<Tag> results = (List<Tag>) sessionFactory.getCurrentSession()
					.createCriteria("edu.map.ws.persistent.dao.Tag")
